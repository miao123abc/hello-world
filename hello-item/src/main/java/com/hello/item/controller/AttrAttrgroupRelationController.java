...
public class AttrAttrgroupRelationController {
     ...
     */
    @RequestMapping("/list")
    // @RequiresPermissions("item:attrattrgrouprelation:list")
    ...
    // @RequiresPermissions("item:attrattrgrouprelation:info")
     ...
     */
    @RequestMapping("/save")
    // @RequiresPermissions("item:attrattrgrouprelation:save")
    ...
    // @RequiresPermissions("item:attrattrgrouprelation:update")
    ...
    // @RequiresPermissions("item:attrattrgrouprelation:delete")
